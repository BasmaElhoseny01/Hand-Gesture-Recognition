...
def train_model(X_train, Y_train, option):
    ...
    if (option == "svm"):
        ...
        clf = RandomForestClassifier(n_estimators=380, min_impurity_decrease=0.0009,
                                     max_features='sqrt', random_state=14, criterion='gini')
...
def train_randomforest(X_train, y_train, X_test, y_test):
    ...
    rf = RandomForestClassifier(
        n_estimators=100, random_state=42, criterion='log_loss')
