...
def process_image_file(img_name: str,
    ...
    # show_images([org_image,shadow_clear,mask],['org_image','shadow_clear','mask'])
    # return None
    ...
    if save:
        ...
        # cv.imwrite('D:\Hand-Gesture-Recognition\src/shadow.jpg', shadow_clear)
        show_images([cv.cvtColor(shadow_clear, cv.COLOR_BGR2RGB)],['res'])
