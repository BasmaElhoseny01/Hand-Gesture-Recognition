...
def extract_features(images,option,train,visual_words=None,clusters=10):
    ...
    Y = []
    if(option=="orb"):
        X, Y, visual_words=orb_descriptors(images,train=train,visual_words=visual_words,clusters=clusters)
    ...
    for i in range(6):
        ...
        for img in images[str(i)]:
            if(option=="hog"):
                ...
                fd, hog_image = hog(img, orientations=16, pixels_per_cell=(16, 16),
