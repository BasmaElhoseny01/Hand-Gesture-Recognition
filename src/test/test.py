...
def main(argv):
    ...
    filename = "./models/Trained_OCR_RF.joblib"
    ...
    filename = "./models/Trained_MASK_SVM.joblib"
    svm_model = joblib.load(filename)

    print('Loading Model MASK_RF ....')
    filename = "./models/Trained_MASK_RF.joblib"
    ...
    for filename in files:
        ...
        try:
            ...
            print('An exception occurred in stage: ', str(e))
